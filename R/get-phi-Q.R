...
get_phi_Q <- function(phi_N, Q) {
  ...
  # Years
  if (!dim(phi_N)[2] == dim(Q)[1]) {
    # Note year is second dimension of phi_N and first dimension of Q
  ...
  # Ages
  if (!dim(phi_N)[3] == dim(Q)[2]) {
    # Note age is third dimension of phi_N and second dimension of Q
