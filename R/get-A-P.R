...
get_A_P <- function(A_phi, phi_dot_E) {
  ...
  # Years
  if (!dim(A_phi)[2] == dim(phi_dot_E)[1]) {
    # Note year is second dimension of A_phi and first dimension of phi_dot_E
  ...
  # Ages
  if (!dim(A_phi)[3] == dim(phi_dot_E)[2]) {
    # Note age is third dimension of A_phi and second dimension of phi_dot_E
