...
#'
#' @return List with two elements. First element: numeric, array of spawner values for Chinook with two dimensions: population (i), and year (y).
#'         Second element: data frame version of array, for plotting and tables.
#'
#' @examples
#' # Sum ages method
