...
[This methods document](inst/methods.pdf) contains detailed methods, variables, and equations matching this package as much as possible. 
...
The `data/` folder contains example data that are all made up (exception is Kitsumkalum River escapement data), so don't use this for any analysis. This is only for package testing and examples. Example data goes from return years 1984-2020.
...
```{r example_omega, dpi = 300 , fig.width = w,fig.height=h}
ex_n <- ex_n
...
```{r example_K_star, dpi = 300, fig.width = w, fig.height=h}
...
```{r example_E_star, dpi=300, fig.width = w,fig.height=h}
...
```{r example_S_star, dpi = 300, fig.width = w,fig.height=h }
...
```{r example_W_star, dpi = 300, fig.width = w,fig.height=h }
...
```{r example_p, dpi = 300 , fig.width = w,fig.height=h}
...
Get age proportions by age, population and year (fake data), including jacks.

```{r example_omega_J, dpi = 300 , fig.width = w,fig.height=h/2}
...
```{r example_Tau_L_total, dpi = 300 , fig.width = w,fig.height=h/2}
...
```{r example_Tau_U_total, dpi = 300 , fig.width = w,fig.height=h/2}
...
```{r example_tau_L, dpi = 300 , fig.width = w,fig.height=h}
...
Estimate freshwater terminal mortalities in the upper Skeena by population, year, and age. Should be 0 for Kitsumkalum, Lower Skeena, and Zymoetz. 


```{r example_tau_U, dpi = 300, fig.width = w,fig.height=h }
...
```{r example_tau_M, dpi = 300 , fig.width = w,fig.height=h}
...
```{r example_tau_W, dpi=300, fig.width = w,fig.height=h}
...
```{r example_TermRun, dpi=300, fig.width = w,fig.height=h}
...
```{r example_MatureRun, dpi=300, fig.width = w,fig.height=h}
...
```{r example_A_phi, dpi=300, fig.width = w,fig.height=h}
ex_r <- ex_r
...
```{r example_A_P, dpi=300, fig.width = w,fig.height=h}
...
```{r example_phi_N, dpi=300, fig.width = w,fig.height=h}
...
```{r example_phi_Q, dpi=300, fig.width = w,fig.height=h}
...
```{r example_N, dpi=300, fig.width = w,fig.height=h}
