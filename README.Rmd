...
```{r example_omega_J, dpi = 300 , fig.width = w,fig.height=h}
...
```{r example_Tau_L_total, dpi = 300 , fig.width = w,fig.height=h}
Tau_L_total <- get_Tau_U_total( omega_J = ex_omega_J, rec_catch_U = ex_Tau$rec_catch_U,
                                   FN_catch_U = ex_Tau$FN_catch_U)
Tau_L_total_df <- data.frame(Tau_L_total, y = names(Tau_L_total))

ggplot( Tau_L_total_df, aes(y = Tau_L_total, x = y)) +
  geom_point() + 
  geom_line() + 
  geom_hline(aes(yintercept=0)) + 
  ylab(TeX("$T_L$") )+
...
```{r example_Tau_U_total, dpi = 300 , fig.width = w,fig.height=h}
...
ggplot( Tau_U_total_df, aes(y = Tau_U_total, x = y)) +
  geom_point() + 
  geom_line() + 
  geom_hline(aes(yintercept=0)) + 
  ylab(TeX("$T_U$") )+
