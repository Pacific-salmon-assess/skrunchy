...
Get spawners for each population, plot with returns to Terrace and escapement (note, will only be different for Skeena aggregate and Kitsumkalum, since brood removals are only for Kitsumkalum).
